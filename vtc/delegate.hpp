...
class member_func_wrapper final : public func_wrapper<ReturnT, Args...>
{
public:
...
template<typename T, typename ReturnT, typename... Args>
class const_member_func_wrapper final : public func_wrapper<ReturnT, Args...>
{
public:
...
template<typename ReturnT, typename... Args>
class nonmember_func_wrapper final : public func_wrapper<ReturnT, Args...>
{
public:
...
template<typename ReturnT, typename... Args>
class func_obj_wrapper final : public func_wrapper<ReturnT, Args...>
{
public:
...
public:
    template<typename T>
    [[maybe_unused]] delegate(T *obj, ReturnT (T::*func)(Args...))
        : wrapper_(std::make_unique<details::member_func_wrapper<T, ReturnT, Args...>>(obj, func))
    {}

    template<typename T>
    [[maybe_unused]] delegate(const T *obj, ReturnT (T::*func)(Args...) const)
        : wrapper_(std::make_unique<details::const_member_func_wrapper<T, ReturnT, Args...>>(obj, func))
    {}

    [[maybe_unused]] explicit delegate(ReturnT(func)(Args...))
        : wrapper_(std::make_unique<details::nonmember_func_wrapper<ReturnT, Args...>>(func))
    {}

    explicit delegate(std::function<ReturnT(Args...)> func)
        : wrapper_(std::make_unique<details::func_obj_wrapper<ReturnT, Args...>>(func))
    {}
